...
key = 'AIzaSyDVrVDtn4F2tqpQDg8DeQ7KnL2avbkZ8Pk '
TEST_LINK='https://www.googleapis.com/youtube/v3/commentThreads?part=snippet&maxResults=100&order=relevance&videoId=tCXGJQYZ9JA&key=AIzaSyDVrVDtn4F2tqpQDg8DeQ7KnL2avbkZ8Pk'


def commentExtract(videoId, count=-1):
    print("Comments downloading")
    page_info = requests.get('https://www.googleapis.com/youtube/v3/commentThreads?part=snippet&maxResults=100&order=relevance&videoId=tCXGJQYZ9JA&key=AIzaSyDVrVDtn4F2tqpQDg8DeQ7KnL2avbkZ8Pk')
